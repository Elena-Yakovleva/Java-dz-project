# Лекция 12. Композиция и зависимость объектов. Mockito при создании авто-тестов
...
## Сделанное ДЗ
1. Poster - объект с параметрами афиши
2. ManagerConstructor - менеджер с кодом. Вывод фильмов в обратном порядке () с лимитом объектов "по умолчанию" и заданным количеством афиш) сделан через два конструктора.
3. Manager и Repository - разделение кода на код менеджера и репозитория.  Вывод фильмов в обратном порядке с лимитом объектов по умолчанию, и заданный количеством афиш сделан через конструктор и сеттер.
